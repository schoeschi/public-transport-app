<script>
	...
	config.apiKey = '**EXPIRED-KEY-REMOVED**';

	const MAPTILER_STYLE_URL = MapStyle.STREETS;
	const DIRECTIONS_API_URL =
		'https://corsproxy.io/?url=https://maps.googleapis.com/maps/api/directions/json?origin=47.399,8.05598&destination=47.391579694240775,8.05138092567529&key=**EXPIRED-KEY-REMOVED**';
